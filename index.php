...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="#page-top">Al-AZAR SCHOOL</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="sessionLoginForm1.html">Login</a></li>
                    </ul>
                </div>
            </div>
        </nav>
        ...
        <header class="masthead bg-primary text-white text-center">
            <div class="container d-flex align-items-center flex-column">
                ...
                <!-- Masthead Heading-->
                <h1 class="masthead-heading text-uppercase mb-0">Penerimaan Peserta Didik Baru</h1>
                <!-- Icon Divider-->
                ...
                <!-- Masthead Subheading-->
                <p class="masthead-subheading font-weight-light mb-0">Ananda Ayu SCHOOL</p>
            </div>
        </header>
        <!-- Portfolio Section-->
        ...
        <section class="page-section bg-primary text-white mb-0" id="panduan">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mr-auto"><p class="lead">Langkah pertama mendaftar adalah klik tombol DAFTAR, jika belum memiliki akun. Jika sudah memiliki akun maka langsung klik tombol LOGIN pada navbar.</p></div>
                </div>
                <!-- About Section Button-->
                <div class="text-center mt-4">
                    <a class="btn btn-xl btn-outline-light" href="insertForm1.html">
                        Daftar
                    </a>
                </div>
            </div>
        ...
        <div class="copyright py-4 text-center text-white">
            <div class="container"><small>@Ananda Ayu Sekar Wiranti</small></div>
        </div>
